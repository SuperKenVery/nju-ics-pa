...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_04, add_05, push_es, inv,
    /* 0x08 - 0x0b*/ or_r2rm_b, or_r2rm_v, or_rm2r_b, or_rm2r_v,
    /* 0x0c - 0x0f*/ or_i2a_b, or_i2a_v, push_cs, opcode_2_byte,
    /* 0x10 - 0x13*/ adc_r2rm_b, adc_r2rm_v, adc_rm2r_b, adc_rm2r_v,
    /* 0x14 - 0x17*/ adc_i2a_b, adc_i2a_v, push_ss, inv,
    /* 0x18 - 0x1b*/ sbb_r2rm_b, sbb_r2rm_v, sbb_rm2r_b, sbb_rm2r_v,
    /* 0x1c - 0x1f*/ sbb_i2a_b, sbb_i2a_v, push_ds, inv,
    /* 0x20 - 0x23*/ and_20, and_21, and_22, and_23,
    /* 0x24 - 0x27*/ and_24, and_25, inv, inv,
    /* 0x28 - 0x2b*/ sub_28, sub_29, sub_2a, sub_2b,
    /* 0x2c - 0x2f*/ sub_2c, sub_2d, inv, inv,
    /* 0x30 - 0x33*/ xor_r2rm_b, xor_r2rm_v, xor_rm2r_b, xor_rm2r_v,
    /* 0x34 - 0x37*/ xor_i2a_b, xor_i2a_v, inv, inv,
    /* 0x38 - 0x3b*/ cmp_38, cmp_39, cmp_3a, cmp_3b,
    /* 0x3c - 0x3f*/ cmp_3c, cmp_3d, inv, inv,
    /* 0x40 - 0x43*/ inc_40, inc_40, inc_40, inc_40,
    /* 0x44 - 0x47*/ inc_40, inc_40, inc_40, inc_40,
    /* 0x48 - 0x4b*/ dec_48, dec_48, dec_48, dec_48,
    /* 0x4c - 0x4f*/ dec_48, dec_48, dec_48, dec_48,
    /* 0x50 - 0x53*/ push_50, push_50, push_50, push_50,
    /* 0x54 - 0x57*/ push_50, push_50, push_50, push_50,
    /* 0x58 - 0x5b*/ pop_58, pop_58, pop_58, pop_58,
    ...
    /* 0x84 - 0x87*/ test_84, test_85, inv, inv,
    /* 0x88 - 0x8b*/ mov_r2rm_b, mov_r2rm_v, mov_rm2r_b, mov_rm2r_v,
    /* 0x8c - 0x8f*/ mov_8c, lea_8d, mov_8e, pop_8f,
    ...
    /* 0xa8 - 0xab*/ test_a8, test_a9, stos_b, stos_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_c2, ret_c3,
    /* 0xc4 - 0xc7*/ inv, inv, mov_i2rm_b, mov_i2rm_v,
    /* 0xc8 - 0xcb*/ inv, leave_c9, inv, inv,
    /* 0xcc - 0xcf*/ int_3, int_imm, into, iret,
...
instr_func group_1_b_entry[8] =
    {add_80, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, and_80, sub_80, xor_i2rm_b, cmp_80};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_81, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_81, sub_81, xor_i2rm_v, cmp_81};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_83, or_i2rm_bv, adc_i2rm_bv, sbb_i2rm_bv, and_83, sub_83, xor_i2rm_bv, cmp_83};
...
instr_func group_3_b_entry[8] =
    {test_f6, inv, not_rm_b, neg_rm_b, mul_rm2a_b, imul_f6, div_rm2a_b, idiv_f6};

/* 0xf7 */
instr_func group_3_v_entry[8] =
    {test_f7, inv, not_rm_v, neg_rm_v, mul_rm2a_v, imul_f7, div_rm2a_v, idiv_f7};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ mov_from_cr, inv, mov_to_cr, inv,
    ...
    /* 0x40 - 0x43*/ inv, cmovno_rm2r_v, cmovb_rm2r_v, cmovae_rm2r_v,
